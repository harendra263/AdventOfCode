...
def gamma_rate(numbers: List[str]) -> str:
    ...
    return ''.join(
        counter.most_common(1)[0][0] for counter in counts
        )
...
def power_consumption(numbers: List[str]) -> str:
    """
...
def life_supporting_rating(numbers: List[str]) -> str:
    """
...
if __name__ == '__main__':
    ...
    print(life_supporting_rating(numbers))
